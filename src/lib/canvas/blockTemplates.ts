        ...
        children: [
          ...
          },
          {
            ...
            children: [
              ...
              { type: 'button', name: 'CTA', content: 'Get Started', styles: { backgroundColor: '#fff', color: '#8B5CF6', borderRadius: 8 } },
            ],
          },
        ],
      },
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { type: 'button', name: 'Submit', content: 'Send Message', styles: { backgroundColor: '#8B5CF6', color: '#fff', borderRadius: 8 } },
        ],
      },
    ],
  },
